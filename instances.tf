resource "aws_instance" "instances" {
  ...
  vpc_security_group_ids = [aws_security_group.allow_ssh.id,aws_security_group.database.id,aws_security_group.allow_outbound.id, aws_security_group.load_balancer_tg.id]
